 ...
 */
public class HistoryAdapter extends CommonAdapter<FileInfo> {
    ...
    public HistoryAdapter(Context context, List<FileInfo> dataList) {
        super(context, dataList);
    }

    public HistoryAdapter(Context context, List<FileInfo> dataList, int type) {
        super(context, dataList);
        this.mType = type;
    }
    ...
    public View convertView(int position, View convertView) {
        ...
        if(mType == FileInfo.TYPE_APK){ //APK convertView
            ...
            if(convertView == null){
                convertView = View.inflate(getContext(), R.layout.item_history_apk, null);
            ...
            if(convertView == null){
                convertView = View.inflate(getContext(), R.layout.item_history_jpg, null);
