package com.estmob.android.sendanywhere.sdk.ui.example.core;
...
import com.estmob.android.sendanywhere.sdk.ui.example.core.utils.ApkUtils;
import com.estmob.android.sendanywhere.sdk.ui.example.core.utils.FileUtils;
import com.estmob.android.sendanywhere.sdk.ui.example.core.utils.MLog;
import com.estmob.android.sendanywhere.sdk.ui.example.core.utils.ScreenshotUtils;
import com.estmob.android.sendanywhere.sdk.ui.example.core.utils.TimeUtils;
...
public class FileSender extends BaseTransfer implements Runnable {
   ...
   // private DatabaseHelper db;
    ...
    public void parseBody() throws Exception {
        ...
        Log.e(TAG, "parseBody: " +  mFileInfo.getFilePath());
        //db.insertPathandName(mFileInfo.getFilePath());
        //OutputStream bos = new FileOutputStream(FileUtils.gerateLocalFile(mFileInfo.getFilePath(),mFileInfo.getName()));
        //记录文件开始写入时间
...
//            if(mOnSendListener != null) mOnSendListener.onProgress(total, fileSize);
        ...
        mOutputStream.flush();
        //Each socket connection is a communication, if the current OutputStream is not closed. FileReceiver will be blocked there
        mOutputStream.close();
